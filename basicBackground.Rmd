...
At the beginning of a MOT task, featural attention is typically used to select the target objects, as they are typically highlighted with a different color or by flicker. For neurotypical individuals the initial selection phase does not seem to be as demanding (Drew & Vogel, 2008) as the subsequent tracking phase is; the capacity limit for selection is higher [@alvarezHowManyObjects2007] than that of the MOT task overall. When the number of objects to track is low and their speed is slow, participants are capable of tracking objects for at least ten minutes with little loss. Lack of motivation and/or feedback after each trial may explain findings of decrease in performance over shorter periods of time [@wolfeMultipleObjectJuggling2007; @oksamaMultipleObjectTracking2004]. 

Thus, the factor in MOT tasks that limits performance appears to be something about the trajectories and speeds of the moving objects.
