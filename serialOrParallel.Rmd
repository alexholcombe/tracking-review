...
Note that no parameters were fit to the data. A particular sampling time specifies the line. While the lines fit the data fairly well, keep in mind that whether these patterns would replicate remains somewhat uncertain. While the
