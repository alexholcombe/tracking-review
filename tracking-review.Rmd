...
The study of visual attention continues to be dominated by experiments with stimuli that don't move. As we'll see, when objects are put in motion, some of the usual benefits of attentional cuing evaporate. This suggests that with static objects, one can bring to bear additional processes, perhaps cognitive processes, that are only clearly dissociated from lower-level processes by using objects in motion.

Gaining further insights into the processes that underlie tracking will require researchers to improve their methodology. To assist with that, this book will dispel misconceptions about the nature of tracking processes and present the concepts that I believe are needed to think straight about tracking. Finally, reviewing the evidence of this vast literature has highlighted four findings which I believe to be both sound and the most informative about the nature of the underlying processing. These four findings are:
...
I hope you enjoy this journey. In Chapter \@ref(recommendations) I list some of what had to be left out and where to learn more. 
