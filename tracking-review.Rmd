...
The concept of temporal interference is unfamiliar to most researchers, and there ultimately wasn't enough space to explain it in this book. A full explanation, together with possibly implications for how tracking works, is available [here](http://trackinglimits.whatanimalssee.com/).

This chapter provides most of the basis behind 

specific aspect(s) of tracking break down with higher target loads.
