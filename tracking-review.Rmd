...
Each of these could hinder performance more with more targets. They contribute in an unknown mix to tracking with conventional unconstrained MOT trajectories, so we don't know which is most responsible for various results in the literature.
...
tt<- tibble(factor=c("spatial interference","temporal interference","speed limit","Use of motion direction"),
            ...
            `hemifield specificity` = c("medium","high?","high","unknown") )
...
Before 
I'd also like to get one factor out of the way. This is because although it frequently is mentioned by researchers, there is little reason to think it matters much.

## Duration that one can sustain attention

TAKE PEOPLE OFF TASK - C~1 LAPSES LIMIT IT
