...
NEED TO FIX THIS, MAYBE BY FOXUSING ENIRELY ON EXTRAPOLATION AND KICKING MOST OF VELOCITY AS A FEATURE TO THE RESOLUTION CHAPTER
...
<!--FUTURE Do we know whether we can use motion streaks to distinguish opposite directions of motion? Question for Srimant and for Horowitz - did you check whether there was a peak in erorrs in the opposite direction?
-->
