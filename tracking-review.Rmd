...
```{r MOTde, eval=knitr::is_html_output(excludes = "epub"), results = 'asis', fig.cap="A demonstration of multiple object tracking created by Jiri Lukavsky.", echo = F}
...
'<iframe width="560" height="315" 
  src="https://www.youtube.com/embed/lAQM4QJRYV8"
