...
The important point, however, is that their data do suggest strong hemispheric independence. Subsequent work by @chenResourceDemandsObject2013 <!--Didn't compare one to two targets in hemifield but did compare two targets in a hemifield to four targets across two hemifields--> and @holcombeExhaustingAttentionalTracking2012 <!--Calculated two-target prediction, and was about 75% independent, but plenty of noise non-significant speed threshold decreases of c(1.67,1.44,1.7,1.63) 1.98rps->1.85 --> also found high levels of independence.  @shimNumberAttentionalFoci2010<!--Figure 1--> also found a substantial bilateral advantage. 
