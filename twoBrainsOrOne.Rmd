...
Still, they did find that distributing objects to two hemifields could almost double capacity, as if for this task, the two hemispheres functioned almost as two different brains. Subsequent work by @holcombeExhaustingAttentionalTracking2012 <!--Calculated two-target prediction, and was about 75% independent, but plenty of noise non-significant speed threshold decreases of c(1.67,1.44,1.7,1.63) 1.98rps->1.85 --> and @chenResourceDemandsObject2013 also found that hemifields were not far from completely independent. A few researchers did not duplicate this result - @shimSpatialSeparationTargets2008 <!--performance in all the conditions involved in their comparison were great- er than 85% correct, including many low speeds where performance was near ceiling --> @shimNumberAttentionalFoci2010<!--Figure 1--> found a bilateral advantage, but far from complete independence.
...
Contrary results . Affirming results @shimNumberAttentionalFoci2010
...
Most of these tasks more targets was confounded with having to make more responses and remember said responses at the end of the trial, so some of the residual cost could be due to that being unitary rather than hemifield-specific.
