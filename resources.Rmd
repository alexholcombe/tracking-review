...
Long before @franconeriHowManyLocations2007 conducted their experiments on the selection of multiple locations with different densities, researchers had recognized the existence of spatial interference in dense displays [@wolfordPerturbationModelLetter1975; @korteUberGestaltauffassungIm1923].
...
node [shape = rectangle, style = filled, pencolor = White, fillcolor = Linen, fontsize = 40]

a [label = 'A', fillcolor = White]
fixation [label =  '', shape=circle, fillcolor=Black, width=.1, height=.1]
b [label = 'B', fillcolor=White]
c [label = 'C', fillcolor=White]
d [label = 'D', fillcolor=White]
e [label = 'E', fillcolor=White]
f [label = 'F', fillcolor=White]
g [label = 'G', fillcolor=White]
h [label = 'H', fillcolor=White]
...
For neurotypical individuals the initial selection phase does not seem to be as demanding (Drew & Vogel, 2008) as the subsequent tracking phase is; the capacity limit for selection is higher [@alvarezHowManyObjects2007] than that of the MOT task overall.
