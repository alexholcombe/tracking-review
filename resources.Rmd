...
The overwhelming majority of MOT papers use trajectories for which the objects frequently come much closer to each other than the crowding zone. As a result, some of the difficulty in covert MOT stems from crowding of the targets. 
