...
Our minds are severely limited in how much information they can extensively process, in spite of being massively-parallel at our visual front ends. When participants attempt to track moving objects, only a very limited number can be tracked. Spatial selection and updating seems to have higher capacity than updating of other features, and is mediated by processes specific to each cerebral hemisphere, such that each hemifield has its own spatial tracking capacity limit. Spatial selection may be a bottleneck that sets the stage for subsequent processing. Improving our understanding of this bottleneck requires preventing contamination of behavioral tasks by cognition. We are far from fully understanding how attention keeps up with multiple moving objects, but what we already know illuminates the architecture of visual processing and offers promising directions for new discoveries.
