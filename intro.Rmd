...
1. Temporal resolution gets worse with target load, but target load has little effect on spatial resolution (Section \@ref(spatialInterference))

There wasn't enough space to cover everything we know about tracking, so in Chapter \@ref(recommendations) I list some of what had to be left out and where to learn more. I hope you enjoy the journey. 
