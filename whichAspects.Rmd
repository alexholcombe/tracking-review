...
For a "standard" MOT experiment with fairly unconstrained trajectories, it is unclear the extent to which each factor is involved.
these factors combine in an unknown mix to det

The factors in our list contribute in an unknown mix to tracking with conventional unconstrained MOT trajectories, so we don't know which is most responsible for various results in the literature. 
