...
In the first section of this book (\@ref(intro)), I flagged four important findings from the literature. As we've seen from this review of the literature, all of these findings are quite well supported.
...
It's not really a finding about how tracking works, but another important result is how good the MOT task typically is: its high test-retest reliability, of approximately .8 or .9, which is among the highest of attentional tasks (Section \@ref(abilities)). The outlook for future work, then, is positive both from the prospect of new results being credible (because with a non-noisy task, less data is needed to have high statistical power) and for the use of MOT as a tool to study individual differences.
